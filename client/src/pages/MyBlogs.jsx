...
import { viewMyBlogs } from '../services/blog'
...
function MyBlogs() {
    ...
    async function onUpdate(blog_id,category_id,title,contents) {
        setBlogId({blog_id,category_id,title,contents})
    ...
    async function getMyBlogs() {
        const result = await viewMyBlogs()
        if (result.status == 'success') {
    ...
    return (
        <div>
            ...
            <div className="container">
                <h1 style={{ textAlign: 'center ', margin: '10px', color: '#E5770B' }}>My Blogs</h1>
                <div className="row">
                                            ...
                                            <tr key={index + 1} className='text-center'>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" className="btn btn-outline-warning m-1" onClick={()=>{
                                                        onUpdate(e.blog_id,e.category_id,e.title,e.contents)
                                                    }}>Update</button>
